            ...
            with steps.start('Store data',continue_=True) as step:              
                ...
                if self.parsed_show_ip_int_brief is not None:
                    ...
                    for filetype in filetype_loop:
                        parsed_output_type = sh_ip_int_brief_template.render(to_parse_interfaces=self.parsed_show_ip_int_brief['interface'],device_alias = device.alias,filetype_loop_jinja2=filetype)
