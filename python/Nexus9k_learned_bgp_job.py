...
$ pyats run job Nexus9k_learned_bgp_job.py --testbed-file testbed/testbed_DevNet_Nexus9k_Sandbox.yaml
...
def main(runtime):
    ...
    testscript = os.path.join(os.path.dirname(__file__), 'Nexus9k_learned_bgp.py')
