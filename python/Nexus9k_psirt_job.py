...
$ pyats run job Nexus9k_psirt_job.py --testbed-file testbed/testbed_DevNet_CSR1000v_Sandbox.yaml
...
def main(runtime):
    ...
    testscript = os.path.join(os.path.dirname(__file__), 'Nexus9k_psirt.py')
